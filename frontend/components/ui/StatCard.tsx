    ...
    <article className="flex min-h-[132px] flex-col justify-between rounded-2xl border border-[var(--color-border)] bg-[var(--color-surface-raised)] p-4 shadow-[0_8px_24px_rgba(15,23,42,0.04)]">
      <div className="flex items-start justify-between gap-4">
        <div className="min-w-0">
          ...
          <p className="mt-2 text-[23px] font-semibold tracking-tight text-[var(--color-foreground)]">
            {value}
          </p>
        </div>
        <span
          className={cn(
            "shrink-0 rounded-full bg-[var(--color-surface-muted)] px-2.5 py-1 text-[11px] font-semibold",
            toneClasses[tone],
          )}
        >
          {delta}
